...
public class UserThird implements ActionListener, Runnable {
    ...
    UserThird() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/Mody_University_logo.png"));
        ...
        JLabel name = new JLabel("Mody University");
        name.setBounds(110, 15, 100, 18);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SAN_SERIF", Font.BOLD, 18));
        p1.add(name);
        
        JLabel status = new JLabel("Palak, Khushi, Neha, Aadya, Simran, Firoja");
